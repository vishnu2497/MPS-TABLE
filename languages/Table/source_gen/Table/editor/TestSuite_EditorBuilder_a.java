...
/*package*/ class TestSuite_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.rule$rkBU;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.rule$rkBU);
    }
  ...
  public Grid createChildsVertical_vyeyr_a2a(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.tests$rkAW)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.tests$rkAW);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.tests$rkAW)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.tests$rkAW)).getElement(y) : null), LINKS.tests$rkAW);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.tests$rkAW)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.tests$rkAW, editorContext);
