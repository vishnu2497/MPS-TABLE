...
/*package*/ class Rule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class variablesListHandler_z0m96w_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.variables$rkOX;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Variable$LZ;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(variablesListHandler_z0m96w_c0.this.getNode(), LINKS.variables$rkOX));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Variable$LZ = MetaAdapterFactory.getConcept(0x47a015d346f64146L, 0xb38ba6894b8669ceL, 0x41d3cf74efea1c2fL, "Table.structure.Variable");
  }
